...
class Users_To_Marks_model extends Plain_Model
{
    ...
    public function readComplete($where, $limit=1, $page=1, $start=null, $options=array())
    {
        ...
        // Default fields
        $fields = "
            users_to_marks.users_to_mark_id AS mark_id, users_to_marks.title AS user_title, users_to_marks.notes, users_to_marks.active, users_to_marks.created_on, users_to_marks.archived_on,
